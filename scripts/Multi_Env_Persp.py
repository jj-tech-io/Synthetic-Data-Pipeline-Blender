...
def set_random_hdri(hdri_directory):
    ...
    background_strength = random.uniform(0, 1)
...
def look_at(obj, target):
    ...
    adjusted_rotation.x += radians(0)  # Add 90 degrees to the X rotation
...
def render_camera_from_vertices(camera, vertices, cursor_location, mesh_obj, vertex_group_name):
...
def main():
    ...
    render_camera_from_vertices(camera, random_vertices, cursor_location, hemisphere_mesh, VERTEX_GROUP_NAME)
